          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				?>
					<?php if($_SESSION['akses']==1){?><a href="form.php" class="btn btn-default pull-right">Tambah Praktikum <i class="fa fa-plus"></i></a><?php }?>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-hover table-bordered table-striped">
					...
					<?php
					if($_SESSION['akses']==1){
					$sql = mysql_query("SELECT * FROM praktikum JOIN mata_kuliah on mata_kuliah.id_mk=praktikum.id_mk ORDER BY id_prak desc");}
					if($_SESSION['akses']==2){
					...
					?>	
                      ...
                      <tr>
						...
						<td><?php if($_SESSION['akses']==1){?><div class="btn-group">
