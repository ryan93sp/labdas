                ...
                <form role="form" action="update_process.php" method="post">
                  <div class="box-body">
					<div class="form-group">
                      <input type="text" class="form-control" name="idjp" value="<?php echo $idjp; ?>" readonly>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<?php
							...
							$dtjp = mysql_fetch_array($sql);
						?>
						<input type="number" class="form-control" name="kuota" value="<?php echo $dtjp['kuota']; ?>" required>
					</div>
					<div class="form-group">
						<label for="jadwal">Jadwal</label>
						<select id="jadwal" name="jadwal" class="form-control" readonly>
						<?php
							$sql = mysql_query("SELECT * FROM jadwal_praktikum join jadwal on jadwal.id_jadwal=jadwal_praktikum.id_jadwal join hari on hari.id_hari=jadwal.id_hari join shift on shift.id_shift=jadwal.id_shift where id_jad_prak=$idjp");
							$dt = mysql_fetch_array($sql);
							echo "<option value=\"$dt[id_jadwal]\" selected>$dt[nama_hari] / $dt[ket_shift]</option>";
						?>
						</select>
					</div>
					<div class="form-group">
