      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			<div class="box box-primary">
                ...
                <!-- form start -->
				<?php 
					$query = mysql_query("SELECT MAX(id_praktikan) AS id_praktikan FROM praktikan");
					$jad = mysql_fetch_array($query);
					$idmax = $jad['id_praktikan'];
                ...
                <form role="form" action="create_process.php" method="post">
                  <div class="box-body">
					<div class="form-group">
                      <input type="text" class="form-control" name="idpt" value="<?php echo $idmax; ?>" readonly>
                    </div>
					<div class="form-group">
					...
					<?php if (isset($idjp)){ ?>
						...
						<div class="form-group hidden">
							<input type="text" class="form-control" name="idpr" value="<?php echo $d['id_prak']; ?>" readonly>
						</div>
					<?php ;} ?>
					<div class="form-group">
