            ...
            <div class="col-xs-12">
              ...
              <div class="box">
				...
				?>
                  ...
                  <h3 class="box-title">Daftar Praktikan Pending</h3>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-hover table-bordered table-striped">
					...
					WHERE status_pr=0 and status=1");}
					...
					JOIN praktikum on praktikum.id_prak = jadwal_praktikum.id_prak
					JOIN mata_kuliah on mata_kuliah.id_mk = praktikum.id_mk
					WHERE status_pr=0 and status=1 and id_praktikan=$idp");}
					...
					?>	
                      <tr>                      
						...
						<a href="delete.php?id=<?php echo $data['id_praktikan']; ?>" class="btn btn-sm btn-default" title='Hapus' onclick="return confirm('Anda yakin menghapus praktikan<?php echo " $nama" ?>?')" ><i class="fa fa-remove"></i></a></td>
                      </tr>
					<?php } ?>
                    </tbody>
                  </table>
